        ...
        <div className="flex flex-col h-full overflow-hidden bg-zinc-50/50 animate-in fade-in">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8">
                    ...
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div className="bg-white p-5 rounded-2xl border border-zinc-200 shadow-sm flex items-center gap-4">
                                <div className="p-3 bg-zinc-50 text-zinc-600 rounded-xl border border-zinc-100"><Hammer size={20}/></div>
                            ...
                            <div className="bg-white p-5 rounded-2xl border border-zinc-200 shadow-sm flex items-center gap-4">
                                <div className="p-3 bg-amber-50 text-amber-600 rounded-xl border border-amber-100"><Gavel size={20}/></div>
                            ...
                            <div className="bg-white p-5 rounded-2xl border border-zinc-200 shadow-sm flex items-center gap-4">
                                ...
                                <div className="p-3 bg-blue-50 text-blue-600 rounded-xl border border-blue-100"><CheckCircle2 size={20}/></div>
                ...
                {activeTab === 'Evaluations' && (
                    <div className="bg-white border border-zinc-200 rounded-[32px] p-20 shadow-sm flex flex-col items-center justify-center min-h-[500px] text-center gap-6">
                        ...
                        <div className="flex gap-4">
                            <button onClick={() => setActiveTab('Registry')} className="px-8 py-3 bg-zinc-900 text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-zinc-800 shadow-xl transition-all active:scale-95">Open Evaluation Registry</button>
                        </div>
                    </div>
                )}
                ...
                {activeTab === 'Intelligence' && (
                    <div className="space-y-6">
                        <div className="bg-white border border-zinc-200 rounded-[32px] p-8 shadow-sm h-[400px] flex flex-col">
                             <div className="flex justify-between items-center mb-8">
                                ...
                                <div className="px-3 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-[10px] font-bold border border-emerald-100">FY24 AVG: 42 Days</div>
                             </div>
                             <div className="flex-1 flex items-center justify-center text-zinc-300 border-2 border-dashed border-zinc-100 rounded-2xl">
                        ...
                        <div className="bg-white border border-zinc-200 rounded-3xl p-10 shadow-sm relative overflow-hidden">
                             ...
                             <div className="space-y-8">
                                <div className="flex gap-6 items-start">
                                    <div className="p-3 bg-rose-50 text-rose-700 rounded-2xl shrink-0"><ShieldCheck size={20}/></div>
                                    <div>
                                ...
                                <div className="flex gap-6 items-start">
                                    <div className="p-3 bg-blue-50 text-blue-700 rounded-2xl shrink-0"><ShieldCheck size={20}/></div>
                                    <div>
