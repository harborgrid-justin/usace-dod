        ...
        <div className="p-8 h-full flex flex-col items-center bg-zinc-50/50 overflow-y-auto custom-scrollbar">
            <div className="max-w-4xl w-full space-y-8">
                <div className="text-center space-y-4">
                    ...
                    <div className="flex justify-center bg-white p-1.5 rounded-2xl border border-zinc-200 shadow-sm w-fit mx-auto">
                ...
                <div className="bg-white border border-zinc-200 rounded-3xl p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="flex items-center gap-4">
                        <div className="p-4 bg-zinc-900 text-white rounded-2xl shadow-xl border border-zinc-800"><Calendar size={28}/></div>
                        <div>
                    ...
                    <button className="px-8 py-3 bg-rose-700 text-white rounded-2xl text-xs font-bold uppercase tracking-widest hover:bg-rose-600 shadow-xl shadow-rose-200 flex items-center gap-3 transition-all active:scale-95">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        {tasks[activePeriod].map(task => (
                            <div key={task.id} className="bg-white p-5 rounded-2xl border border-zinc-100 flex justify-between items-center group hover:border-rose-200 transition-all shadow-sm">
                                <div className="flex items-center gap-4">
                                ...
                                <button 
                                    ...
                                    className="px-5 py-2 bg-zinc-900 text-white rounded-xl text-[10px] font-bold uppercase tracking-wider disabled:bg-zinc-100 disabled:text-zinc-400 transition-all group-hover:scale-[1.02] flex items-center gap-2 shadow-md active:scale-95"
                                >
                ...
                {activePeriod === 'Year' && (
                    <div className="p-6 bg-amber-50 border border-amber-200 rounded-3xl flex gap-4 text-amber-900 animate-in zoom-in duration-300">
