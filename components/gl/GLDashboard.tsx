...
const GLDashboard: React.FC = () => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-1 h-full overflow-y-auto custom-scrollbar animate-in fade-in">
            <div className="lg:col-span-1 space-y-6">
                <div className="bg-zinc-900 rounded-md p-8 text-white shadow-2xl relative overflow-hidden border border-zinc-800">
                    ...
                    <div className="space-y-6 relative z-10">
                        <div className="p-5 bg-white/5 rounded-sm border border-white/10 shadow-inner">
                    ...
                    <div className={`mt-10 p-4 rounded-sm flex items-center justify-center gap-4 text-xs font-bold border transition-all shadow-xl ${
                ...
                <div className="bg-white border border-zinc-200 rounded-md p-6 shadow-sm">
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between items-center p-3 bg-zinc-50 rounded-sm border border-zinc-100">
                            <span className="text-xs text-zinc-500 font-medium">USSGL 1010/6653 Match</span>
                            <span className="text-[10px] font-bold text-emerald-600 uppercase bg-emerald-50 px-2 py-1 rounded-sm border border-emerald-100">Verified</span>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-zinc-50 rounded-sm border border-zinc-100">
                            <span className="text-xs text-zinc-500 font-medium">Period Close Status</span>
                            <span className="text-[10px] font-bold text-blue-600 uppercase bg-blue-50 px-2 py-1 rounded-sm border border-blue-100">Open (FY24 05)</span>
                        </div>
                    </div>
                </div>
            </div>

            <div className="lg:col-span-2 bg-white border border-zinc-200 rounded-md p-8 flex flex-col shadow-sm">
                ...
                <div className="space-y-4 overflow-y-auto custom-scrollbar pr-2 flex-1">
                    {transactions.map(tx => (
                        <div key={tx.id} className="p-5 rounded-sm border border-zinc-50 hover:bg-zinc-50 hover:border-rose-200 transition-all group cursor-default">
                            <div className="flex justify-between items-start">
                                <div className="space-y-2">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-[10px] font-mono bg-white text-zinc-500 px-2 py-1 rounded-sm border border-zinc-100 shadow-sm">{tx.sourceModule}</span>
                                    </div>
