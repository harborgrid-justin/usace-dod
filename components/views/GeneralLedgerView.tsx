...
const GeneralLedgerView: React.FC<GeneralLedgerViewProps> = ({ onSelectProject }) => {
    const [activeTab, setActiveTab] = useState<GLTab>('Journals');
    ...
    const tabs: { id: GLTab, label: string, icon: React.ElementType }[] = [
        ...
        <div className="p-4 sm:p-8 space-y-6 animate-in max-w-[1600px] mx-auto h-full flex flex-col">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-xs text-zinc-500 font-medium mt-1">Authoritative Financial Record for USACE (USSGL Compliant)</p>
                </div>
